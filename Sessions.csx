...
List<int> xC2 = tC.CodigoASCII("Luigi da Silva Coleho");
Console.WriteLine(string.Join(", ",xC2));

bool xC3 = tC.TodasVogais("Olá");
Console.WriteLine(xC3);

string xC4 = tC.Alternar(ValoresP1);
Console.WriteLine(xC4);

string xC5 = tC.Inverter("Luigi da Silva Coelho");
...
List<int> ASCII = new List<int> () {
   83, 105, 109, 32, 105, 114, 109, 227, 111, 44, 32, 105, 115, 115, 111, 32, 97, 113, 117, 105, 32, 233, 32, 109, 117, 
   105, 116, 111, 32, 108, 111, 117, 99, 111, 32, 110, 97, 109, 111, 114, 97, 108, 44, 32, 111, 115, 32, 99, 97, 114, 97, 
   115, 32, 110, 227, 111, 32, 118, 227, 111, 32, 99, 111, 110, 115, 101, 103, 117, 105, 114, 32, 101, 110, 116, 101, 110, 
   100, 101, 114, 32, 101, 115, 115, 97, 32, 99, 114, 105, 112, 116, 111, 103, 114, 97, 102, 105, 97
};

List<int> Funcao2TreinoC = tC.CodigoASCII("Teste de Função");
